async function enviarScript(scriptText) {
  ...
  for (const linea of lineas) {
    ...
    const botonEnviar = main.querySelector(`[data-testid="send"]`) || main.querySelector(`[data-icon="send"]`);
    botonEnviar.click();
...
THE END
`).then(cantidadMensajesEnviados => console.log(`Código finalizado, ${cantidadMensajesEnviados} mensajes enviados`)).catch(console.error);
